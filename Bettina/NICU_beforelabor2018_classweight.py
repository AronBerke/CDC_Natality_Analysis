# -*- coding: utf-8 -*-
"""beforelabor2018_classweight.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cXXhfMMFUDeYrMWRDfK63VkCkiIh7j6d
"""
...
wolabor2018 =  wolabor2016[wolabor2016['AB_NICU'].isin(['Y', 'N'])]
...
#grid search
grid_search_xgb = GridSearchCV(xgb, xgb_param_grid, scoring='f1_weighted', cv= 5, n_jobs=-1, return_train_score = True)
# %time grid_search_xgb.fit(X_train, y_train)
...
import pickle
# save model to file
pickle.dump(xgb, open("2016beforelabor_90_10_classweight.pickle.dat", "wb"))
pickle.dump(grid_search_xgb, open("2016beforelabor_90_10_classweight_grid_search_f1_weighted.pickle.dat", "wb"))

# load model later
loaded_model = pickle.load(open("2016beforelabor_90_10_classweight.pickle.dat", "rb"))
