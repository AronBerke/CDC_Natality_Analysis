...
list_to_drop = ['flag','territory', 'imputed']
# you can use as many/few of these and include / remove any other column
...
def create_reduced_df (df, list_to_drop):
    ...
    ----------------------------
    df: full dataframes
    list_to_drop: contains groups of columns that can be dropped, can be extended to any column of interest
    '''
